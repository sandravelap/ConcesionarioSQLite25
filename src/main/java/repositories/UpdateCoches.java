...
public class UpdateCoches {
    public static boolean anularDispoCocheById(Integer idCoche) throws SQLException {
        ...
        String actualizarEstado = "UPDATE coches SET disponible=false WHERE id_coche=? "; // probamos que haga el update a false aunque podemos tener problemas porque es un tinyint
    ...
    public static boolean activarDispoCocheById(Integer idCoche) throws SQLException {
        boolean respuesta = false;
        String actualizarEstado = "UPDATE coches SET disponible=true WHERE id_coche=? "; // probamos que haga el update a false aunque podemos tener problemas porque es un tinyint
        PreparedStatement pst = null;
        ConexionBD conexionBD = new ConexionBD();
        Connection con =conexionBD.connect();
